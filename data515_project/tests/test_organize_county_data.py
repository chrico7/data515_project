...
class UnitTests(unittest.TestCase):
    ...
    def test_dates(self):
        ...
        self.df_start_date = datetime.strptime(
           str(self.df_sorted_by_date.loc[self.df_sorted_by_date['Document Date'].notna()]['Document Date'].iloc[0]),
           "%Y-%m-%d %H:%M:%S")
        self.df_end_date = datetime.strptime(
           str(self.df_sorted_by_date.loc[self.df_sorted_by_date['Document Date'].notna()]['Document Date'].iloc[-1]),
           "%Y-%m-%d %H:%M:%S")
