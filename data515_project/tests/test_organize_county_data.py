...
class UnitTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #print(sys.path)
        building = pd.read_csv("https://raw.githubusercontent.com/chrico7/"+
                               "data515_project/master/data515_project/tests/test_data/building.csv")
        sale = pd.read_csv("https://raw.githubusercontent.com/chrico7/"+
                           "data515_project/master/data515_project/tests/test_data/sale.csv")
        
        sale = sale.rename(columns={"Major ":"Major"})
        parcel = pd.read_csv("https://raw.githubusercontent.com/chrico7/"+
                             "data515_project/master/data515_project/tests/test_data/parcel.csv")
        lookup = pd.read_csv("https://raw.githubusercontent.com/chrico7/"+
                             "data515_project/master/data515_project/tests/test_data/EXTR_LookUp.csv")
        self.df_kc = organize_county_data(sale, building, parcel, lookup,
